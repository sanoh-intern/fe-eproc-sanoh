        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="text-center">
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="https://sanohindonesia.co.id/" className="text-sm text-gray-300 hover:text-white" target="_blank">
                  About Sanoh Ind
                </Link>
              </li>
              <li>
                <Link to="#https://sms.sanohindonesia.co.id/" className="text-sm text-gray-300 hover:text-white" target="_blank">
